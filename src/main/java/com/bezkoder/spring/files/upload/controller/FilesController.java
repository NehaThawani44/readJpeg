...
public class FilesController {
  ...
  @GetMapping("/files")
  public ResponseEntity<List<FileInfo>> getListFiles(@RequestParam("filepath") String filepath) throws IOException {
	  //TODO this path should come from UI 
	  Path path = Paths.get(filepath);
	
	 // File[] files = new File("C:\\Example").listFiles();
	  List<FileInfo> fileInfos = storageService.loadAll(filepath);
